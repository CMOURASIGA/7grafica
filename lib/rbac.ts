...
export const PERMISSOES = {
  AUDITORIA_REGISTRAR: "auditoria_registrar",
  USUARIOS_CONSULTAR: "usuarios_consultar",
...
export const MATRIZ_PAPEIS: Record<Papel, Permissao[]> = {
  admin: [
    PERMISSOES.AUDITORIA_REGISTRAR,
    PERMISSOES.USUARIOS_CONSULTAR,
    ...
    PERMISSOES.ENTREGA_GERENCIAR,
    PERMISSOES.ENTREGA_CONSULTAR,
  ...
  operador: [PERMISSOES.AUDITORIA_REGISTRAR, PERMISSOES.USUARIOS_CONSULTAR, PERMISSOES.ENTREGA_CONSULTAR, PERMISSOES.ESTOQUE_CONSULTAR, PERMISSOES.CADASTROS_OPERACIONAIS_VISUALIZAR, PERMISSOES.PRODUCAO_CONSULTAR, PERMISSOES.ARQUIVOS_CONSULTAR],
};
