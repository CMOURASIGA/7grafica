...
export const MATRIZ_PAPEIS: Record<Papel, Permissao[]> = {
  ...
  operador: [PERMISSOES.ENTREGA_CONSULTAR, PERMISSOES.ESTOQUE_CONSULTAR, PERMISSOES.CADASTROS_OPERACIONAIS_VISUALIZAR, PERMISSOES.PRODUCAO_CONSULTAR, PERMISSOES.ARQUIVOS_CONSULTAR],
};
