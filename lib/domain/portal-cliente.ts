...
export type PedidoPortal = { pedido: Pedido; recebimentos: Recebimento[]; trabalhos: Trabalho[]; arquivosLiberados: Arquivo[]; orcamento: Orcamento | null; recebido: number; saldo: number };
