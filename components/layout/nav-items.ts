...
export type NavItem = {
  ...
  href: string;
  label: string;
  icon: "home" | "settings" | "audit";
  /** Quando definido, o item so aparece se o usuario tiver essa permissao na empresa ativa. */
  permissaoRequerida?: Permissao;
};

// Navegacao da Foundation. Nenhum modulo de negocio (pedidos, PDV, kanban,
// estoque, financeiro, portal) entra aqui antes da respectiva SPEC.
